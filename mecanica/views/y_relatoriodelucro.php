...
<html>
    ...
    <body>
        <header> 
            <div id="logo">
                <img id="logo_menuprincipal" src="../assets/images/logo_relatoriolucro.png" alt="Folha de papel com sifrão e gráfico em forma de pizza">
            </div>
            <div id="tela">
                <h1>RELATÓRIOS</h1>
            </div>
            ...
            <div id="flex_main">
                <div id="main_esq">
                    ...
                    <div id="rodape_main_esq">
                        <nav class="navegacao">
                            <div><a href= "../index.php">Menu Inical</a></div>
                        </nav> 
                    </div> 
                </div>
                <div id="main_dir">
