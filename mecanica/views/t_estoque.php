            ...
            <div id="flex_main">
                <div id="main_esq">
                    <div id="cabecalho_main_esq">
                        <nav class="navegacao">
                            <div><a href="t_atualizarestoque.php">Atualizar Estoque</a></div>
                            <div><a href= "t_cadastrarproduto.php">Cadastrar Produto</a></div>
                            <div><a href= "t_excluirproduto.php">Excluir Produto</a></div>
                            <div><a href= "t_atualizarproduto.php">Atualizar Produto</a></div>
                        </nav> 
                    </div> 
